  ...
  <div class="">
    <header class="py-4 bg-white sm:py-5">
      <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <nav class="flex items-center justify-between">
          ...
          >
            <a
              href="#"
              title=""
              class="text-base font-medium text-gray-900 transition-all duration-200 hover:text-indigo-600"
              >Features</a
            >
            <a
              href="#"
        ...
        <nav v-show="expanded" x-collapse="">
          <div class="px-1 pt-8 pb-4">
            <div class="grid gap-y-6">
              <a
                href="#"
                title=""
                class="flex items-center text-base font-medium text-gray-900 transition-all duration-200 focus:outline-none focus:ring-0"
                >Features</a
              >
              <a
                href="#"
    ...
    <section class="relative bg-gray-50">
      <div
        class="relative z-10 px-4 py-12 sm:py-16 sm:px-6 lg:px-8 lg:max-w-7xl lg:mx-auto lg:py-20 xl:py-28 lg:grid lg:grid-cols-2"
      >
        <div class="lg:pr-8">
          <div class="max-w-md mx-auto sm:max-w-lg lg:mx-0">
            ...
            <form action="#" method="post" class="relative mt-4">
              <div
                class="absolute transitiona-all duration-1000 opacity-30 inset-0 bg-gradient-to-r from-[#44BCFF] via-[#FF44EC] to-[#FF675E] rounded-xl blur-lg filter group-hover:opacity-100 group-hover:duration-200"
              ></div>
      ...
      <div class="pb-8 lg:absolute lg:inset-0 lg:pb-0">
        <div
          class="flex flex-col items-center justify-center overflow-hidden lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2"
        >
          <div
